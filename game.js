...
const MODALS = {
  ...
  help:{ title:'도움말', render(b){
    const topics={
      ...
      '영웅':`영웅은 등급(일반→레전더리)과 레벨로 성장합니다. 소환으로 조각을 모아 합성하면 등급이 오르고 스킬이 해금됩니다. 각성은 계정 전체 스탯을 +1.5%/단계 올립니다(기본 12단계 · 이후 심화 각성으로 최대 30단계, 영웅 기록서 소모).<br><br>강화 실패 시 장비가 파괴됩니다. 파괴방지에는 일반 망치 5개·희귀 망치 10개·영웅 전설망치 5개·레전더리 전설망치 10개가 필요합니다.`,
